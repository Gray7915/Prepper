...
public class ShortAnsQuestionViewController {
    ...
    public void setQuestion(int questionNumber){
        shortAnswerQuestions.get(questionNumber);
        Question = shortAnswerQuestions.get(questionNumber).getQuestion();
        example = shortAnswerQuestions.get(questionNumber).getAnswer();
    }
